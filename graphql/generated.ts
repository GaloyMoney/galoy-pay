...
export type CurrencyListQuery = { readonly __typename: 'Query', readonly currencyList: ReadonlyArray<{ readonly __typename: 'Currency', readonly id: string, readonly name: string, readonly flag: string, readonly fractionDigits: number, readonly symbol: string }> };
...
export type AccountDefaultWallet2Query = { readonly __typename: 'Query', readonly accountDefaultWallet: { readonly __typename: 'PublicWallet', readonly id: string, readonly walletCurrency: WalletCurrency } };
 ...
 * });
 */
export function useAccountDefaultWallet2Query(baseOptions: Apollo.QueryHookOptions<AccountDefaultWallet2Query, AccountDefaultWallet2QueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AccountDefaultWallet2Query, AccountDefaultWallet2QueryVariables>(AccountDefaultWallet2Document, options);
      }
export function useAccountDefaultWallet2LazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AccountDefaultWallet2Query, AccountDefaultWallet2QueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AccountDefaultWallet2Query, AccountDefaultWallet2QueryVariables>(AccountDefaultWallet2Document, options);
        }
export type AccountDefaultWallet2QueryHookResult = ReturnType<typeof useAccountDefaultWallet2Query>;
export type AccountDefaultWallet2LazyQueryHookResult = ReturnType<typeof useAccountDefaultWallet2LazyQuery>;
export type AccountDefaultWallet2QueryResult = Apollo.QueryResult<AccountDefaultWallet2Query, AccountDefaultWallet2QueryVariables>;